...
namespace CM0102_Starter_Kit {
    class Helper {
        ...
        internal static bool IsWindowsVistaOrLower() {
        ...
        internal static readonly Database OriginalDatabase = new Database("original_database", "Original (3.9.60)", Properties.Resources.original_data, true, DefaultButtonNames);
        internal static readonly Database PatchedDatabase = new Database("patched_database", "Patched (3.9.68)", Properties.Resources.patched_data, true, DefaultButtonNames);
